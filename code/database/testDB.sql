...
--
-- Host: localhost:3306
-- Generation Time: Dec 07, 2018 at 12:41 PM
...
CREATE TABLE `city_master` (
  `iCityId` int(11) UNSIGNED NOT NULL,
  `vCityName` varchar(30) NOT NULL,
  `iStateId` int(11) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1666, 'Kottagudem', 2),
(1667, 'Kukatpalle', 2),
(1668, 'Lalbahadur Nagar', 2),
(1669, 'Machilipatnam', 2),
(1670, 'Mahbubnagar', 2),
(1671, 'Malkajgiri', 2),
(1672, 'Mancheral', 2),
(1673, 'Mandamarri', 2),
...
(1694, 'Rajamahendri', 2),
(1695, 'Rajampet', 2),
(1696, 'Rajendranagar', 2),
(1697, 'Ramachandrapuram', 2),
(1698, 'Ramagundam', 2),
(1699, 'Rayachoti', 2),
(1700, 'Rayadrug', 2),
(1701, 'Samalkot', 2),
...
(1745, 'Arambagh', 41),
(1746, 'Asansol', 41),
(1747, 'Ashoknagar Kalyangarh', 41),
(1748, 'Baharampur', 41),
(1749, 'Baidyabati', 41),
(1750, 'Baj Baj', 41),
(1751, 'Bally', 41),
(1752, 'Bally Cantonment', 41),
(1753, 'Balurghat', 41),
(1754, 'Bangaon', 41),
(1755, 'Bankra', 41),
(1756, 'Bankura', 41),
...
(1784, 'Halisahar', 41),
(1785, 'Haora', 41),
(1786, 'HugliChunchura', 41),
(1787, 'Ingraj Bazar', 41),
(1788, 'Islampur', 41),
(1789, 'Jalpaiguri', 41),
(1790, 'Jamuria', 41),
(1791, 'Jangipur', 41),
...
(1800, 'Katwa', 41),
(1801, 'Kharagpur', 41),
(1802, 'Kharagpur Railway Settlement', 41),
(1803, 'Khardaha', 41),
(1804, 'Kharia', 41),
(1805, 'Koch Bihar', 41),
(1806, 'Konnagar', 41),
(1807, 'Krishnanagar', 41),
(1808, 'Kulti', 41),
(1809, 'Madhyamgram', 41),
(1810, 'Maheshtala', 41),
(1811, 'Memari', 41),
...
(1814, 'Navadwip', 41),
(1815, 'Ni Barakpur', 41),
(1816, 'North Barakpur', 41),
(1817, 'North Dum Dum', 41),
(1818, 'Old Maldah', 41),
(1819, 'Panihati', 41),
(1820, 'Phulia', 41),
(1821, 'Pujali', 41),
...
(1831, 'Shrirampur', 41),
(1832, 'Siuri', 41),
(1833, 'South Dum Dum', 41),
(1834, 'Titagarh', 41),
(1835, 'Ulubaria', 41),
(1836, 'UttarparaKotrung', 41),
(1837, 'Araria', 5),
(1838, 'Arrah', 5),
(1839, 'Aurangabad', 5),
(1840, 'Bagaha', 5),
...
(1894, 'Raipur', 7),
(1895, 'Rajnandgaon', 7),
(1896, 'Bhalswa Jahangirpur', 10),
(1897, 'Burari', 10),
(1898, 'Chilla Saroda Bangar', 10),
(1899, 'Dallo Pura', 10),
(1900, 'Delhi', 10),
(1901, 'Deoli', 10),
(1902, 'Dilli Cantonment', 10),
(1903, 'Gharoli', 10),
(1904, 'Gokalpur', 10),
(1905, 'Hastsal', 10),
(1906, 'Jaffrabad', 10),
(1907, 'Karawal Nagar', 10),
(1908, 'Khajuri Khas', 10),
(1909, 'Kirari Suleman Nagar', 10),
(1910, 'Mandoli', 10),
(1911, 'Mithe Pur', 10),
(1912, 'Molarband', 10),
(1913, 'Mundka', 10),
...
(1918, 'Puth Kalan', 10),
(1919, 'Roshan Pura', 10),
(1920, 'Sadat Pur Gujran', 10),
(1921, 'Sultanpur Majra', 10),
(1922, 'Tajpul', 10),
(1923, 'Tigri', 10),
(1924, 'Ziauddin Pur', 10),
(1925, 'Madgaon', 11),
(1926, 'Mormugao', 11),
(1927, 'Panaji', 11),
(1928, 'Ahmadabad', 12),
...
(1990, 'Wadhwan', 12),
(1991, 'Ambala', 13),
(1992, 'Ambala Cantonment', 13),
(1993, 'Ambala Sadar', 13),
(1994, 'Bahadurgarh', 13),
(1995, 'Bhiwani', 13),
(1996, 'Charkhi Dadri', 13),
(1997, 'Dabwali', 13),
(1998, 'Faridabad', 13),
(1999, 'Gohana', 13),
(2000, 'Hisar', 13),
...
(2049, 'Bagalkot', 17),
(2050, 'Bangalore', 17),
(2051, 'Basavakalyan', 17),
(2052, 'Belgaum', 17),
(2053, 'Bellary', 17),
(2054, 'Bhadravati', 17),
(2055, 'Bidar', 17),
(2056, 'Bijapur', 17),
(2057, 'Bommanahalli', 17),
(2058, 'Byatarayanapura', 17),
(2059, 'Challakere', 17),
(2060, 'Chamrajnagar', 17),
(2061, 'Channapatna', 17),
(2062, 'Chik Ballapur', 17),
(2063, 'Chikmagalur', 17),
(2064, 'Chintamani', 17),
(2065, 'Chitradurga', 17),
(2066, 'Dasarahalli', 17),
(2067, 'Davanagere', 17),
(2068, 'Dod Ballapur', 17),
(2069, 'Gadag', 17),
(2070, 'Gangawati', 17),
(2071, 'Gokak', 17),
(2072, 'Gulbarga', 17),
...
(2085, 'Kollegal', 17),
(2086, 'Koppal', 17),
(2087, 'Krishnarajapura', 17),
(2088, 'Mahadevapura', 17),
(2089, 'Maisuru', 17),
(2090, 'Mandya', 17),
(2091, 'Mangaluru', 17),
(2092, 'Nipani', 17),
...
(2131, 'Manjeri', 19),
(2132, 'Nedumangad', 19),
(2133, 'Neyyattinkara', 19),
(2134, 'Palakkad', 19),
(2135, 'Pallichal', 19),
(2136, 'Payyannur', 19),
(2137, 'Ponnani', 19),
(2138, 'Talipparamba', 19),
(2139, 'Thalassery', 19),
(2140, 'Thiruvananthapuram', 19),
(2141, 'Thrippunithura', 19),
(2142, 'Thrissur', 19),
(2143, 'Tirur', 19),
(2144, 'Tiruvalla', 19),
(2145, 'Vadakara', 19),
...
(2316, 'Firozpur', 32),
(2317, 'Firozpur', 2728),
(2318, 'Firozpur Cantonment', 32),
(2319, 'Firozpur Cantonment', 2728),
(2320, 'Gobindgarh', 32),
(2321, 'Gobindgarh', 2728),
(2322, 'Gurdaspur', 32),
(2323, 'Gurdaspur', 2728),
(2324, 'Hoshiarpur', 32),
(2325, 'Hoshiarpur', 2728),
(2326, 'Jagraon', 32),
(2327, 'Jagraon', 2728),
(2328, 'Jalandhar', 32),
(2329, 'Jalandhar', 2728),
(2330, 'Kapurthala', 32),
(2331, 'Kapurthala', 2728),
(2332, 'Khanna', 32),
(2333, 'Khanna', 2728),
(2334, 'Kot Kapura', 32),
(2335, 'Kot Kapura', 2728),
(2336, 'Ludhiana', 32),
(2337, 'Ludhiana', 2728),
(2338, 'Malaut', 32),
(2339, 'Malaut', 2728),
(2340, 'Maler Kotla', 32),
(2341, 'Maler Kotla', 2728),
(2342, 'Mansa', 32),
(2343, 'Mansa', 2728),
(2344, 'Moga', 32),
(2345, 'Moga', 2728),
...
(2421, 'Arakonam', 35),
(2422, 'Arani', 35),
(2423, 'Aruppukkottai', 35),
(2424, 'Attur', 35),
(2425, 'Avadi', 35),
(2426, 'Avaniapuram', 35),
(2427, 'Bodinayakkanur', 35),
(2428, 'Chengalpattu', 35),
(2429, 'Dharapuram', 35),
(2430, 'Dharmapuri', 35),
(2431, 'Dindigul', 35),
(2432, 'Erode', 35),
(2433, 'Gopichettipalaiyam', 35),
(2434, 'Gudalur', 35),
(2435, 'Gudiyattam', 35),
(2436, 'Hosur', 35),
(2437, 'Idappadi', 35),
(2438, 'Kadayanallur', 35),
(2439, 'Kambam', 35),
(2440, 'Kanchipuram', 35),
(2441, 'Karur', 35),
(2442, 'Kavundampalaiyam', 35),
(2443, 'Kovilpatti', 35),
(2444, 'Koyampattur', 35),
(2445, 'Krishnagiri', 35),
(2446, 'Kumarapalaiyam', 35),
(2447, 'Kumbakonam', 35),
(2448, 'Kuniyamuthur', 35),
(2449, 'Kurichi', 35),
(2450, 'Madhavaram', 35),
(2451, 'Madras', 35),
(2452, 'Madurai', 35),
(2453, 'Maduravoyal', 35),
(2454, 'Mannargudi', 35),
(2455, 'Mayiladuthurai', 35),
(2456, 'Mettupalayam', 35),
(2457, 'Mettur', 35),
(2458, 'Nagapattinam', 35),
(2459, 'Nagercoil', 35),
(2460, 'Namakkal', 35),
(2461, 'Nerkunram', 35),
(2462, 'Neyveli', 35),
...
(2465, 'Pannuratti', 35),
(2466, 'Paramakkudi', 35),
(2467, 'Pattukkottai', 35),
(2468, 'Pollachi', 35),
(2469, 'Pudukkottai', 35),
(2470, 'Puliyankudi', 35),
(2471, 'Punamalli', 35),
(2472, 'Rajapalaiyam', 35),
(2473, 'Ramanathapuram', 35),
(2474, 'Salem', 35),
(2475, 'Sankarankoil', 35),
(2476, 'Sivakasi', 35),
(2477, 'Srivilliputtur', 35),
(2478, 'Tambaram', 35),
(2479, 'Tenkasi', 35),
(2480, 'Thanjavur', 35),
(2481, 'Theni Allinagaram', 35),
(2482, 'Thiruthangal', 35),
(2483, 'Thiruvarur', 35),
(2484, 'Thuthukkudi', 35),
(2485, 'Tindivanam', 35),
(2486, 'Tiruchchirappalli', 35),
(2487, 'Tiruchengode', 35),
(2488, 'Tirunelveli', 35),
(2489, 'Tirupathur', 35),
(2490, 'Tiruppur', 35),
(2491, 'Tiruvannamalai', 35),
(2492, 'Tiruvottiyur', 35),
(2493, 'Udagamandalam', 35),
(2494, 'Udumalaipettai', 35),
(2495, 'Valparai', 35),
(2496, 'Vaniyambadi', 35),
(2497, 'Velampalaiyam', 35),
(2498, 'Velluru', 35),
(2499, 'Viluppuram', 35),
(2500, 'Virappanchatram', 35),
(2501, 'Virudhachalam', 35),
(2502, 'Virudunagar', 35),
(2503, 'Agartala', 37),
(2504, 'Agartala MCl', 37),
(2505, 'Badharghat', 37),
(2506, 'Agra', 38),
(2507, 'Aligarh', 38),
(2508, 'Allahabad', 38),
...
(2582, 'Mawana', 38),
(2583, 'Mirat', 38),
(2584, 'Mirat Cantonment', 38),
(2585, 'Mirzapur', 38),
(2586, 'Modinagar', 38),
(2587, 'Moradabad', 38),
(2588, 'Mubarakpur', 38),
(2589, 'Mughal Sarai', 38),
(2590, 'Muradnagar', 38),
(2591, 'Muzaffarnagar', 38),
(2592, 'Nagina', 38),
(2593, 'Najibabad', 38),
(2594, 'Nawabganj', 38),
(2595, 'Noida', 38),
...
(2608, 'Sandila', 38),
(2609, 'Shahabad', 38),
(2610, 'Shahjahanpur', 38),
(2611, 'Shamli', 38),
(2612, 'Sherkot', 38),
(2613, 'Shikohabad', 38),
(2614, 'Sikandarabad', 38),
(2615, 'Sitapur', 38),
(2616, 'Sukhmalpur Nizamabad', 38),
(2617, 'Sultanpur', 38),
(2618, 'Tanda', 38),
(2619, 'Tilhar', 38),
(2620, 'Tundla', 38),
...
CREATE TABLE `country_master` (
  `iCountryId` int(11) UNSIGNED NOT NULL,
  `vCountryName` varchar(30) NOT NULL
...
(68, 'Estonia'),
(69, 'Ethiopia'),
(70, 'External Territories of Austra'),
(71, 'Falkland Islands'),
(72, 'Faroe Islands'),
(73, 'Fiji Islands'),
(74, 'Finland'),
...
(187, 'Saint Vincent And The Grenadin'),
(188, 'Samoa'),
(189, 'San Marino'),
...
CREATE TABLE `leaves_master` (
  `iLeaveId` int(11) UNSIGNED NOT NULL,
  `iUserId` int(11) UNSIGNED NOT NULL,
  `dtStartDate` date NOT NULL,
  `dtEndDate` date NOT NULL,
  `vReason` varchar(100) NOT NULL,
  `iTotalDay` float(23,19) NOT NULL,
  `iCreatedAt` int(11) UNSIGNED NOT NULL,
  `iUpdatedAt` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `leaves_master`
--

INSERT INTO `leaves_master` (`iLeaveId`, `iUserId`, `dtStartDate`, `dtEndDate`, `vReason`, `iTotalDay`, `iCreatedAt`, `iUpdatedAt`) VALUES
(2, 2, '2018-12-07', '2018-12-10', 'going home', 5.0000000000000000000, 1544087768, 1544087768);

-- --------------------------------------------------------

--
-- Table structure for table `leaves_name`
--

CREATE TABLE `leaves_name` (
  `iLeaveNameId` int(11) UNSIGNED NOT NULL,
  `vLeaveName` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `leaves_name`
--

INSERT INTO `leaves_name` (`iLeaveNameId`, `vLeaveName`) VALUES
(1, 'SL'),
(2, 'CL'),
(3, 'FL'),
(4, 'UL');
...
('m000000_000000_base', 1543827325),
('m130524_201442_init', 1543827328);
...
CREATE TABLE `state_master` (
  `iStateId` int(11) UNSIGNED NOT NULL,
  `vStateName` varchar(30) NOT NULL,
  `iCountryId` int(11) UNSIGNED NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'admin', '8KO3ub2DK37stRI3rnFEAnBRXRtHa27c', '$2y$13$3IGNntfJbI6wLKjULCRn1e/nNpbokR8JNkaMqko19Qw.La9w/7UEu', NULL, 'bhargav.gohel@hodusoft.com', 10, 1543828349, 1543828349);
...
CREATE TABLE `users_master` (
  ...
  `vEmailId` varchar(30) DEFAULT NULL,
  `vPassword` varchar(100) DEFAULT NULL,
  `vProfilePic` varchar(255) DEFAULT NULL,
  `vMobileNo` varchar(20) DEFAULT NULL,
  `iCountryId` int(11) UNSIGNED DEFAULT NULL,
  `iStateId` int(11) UNSIGNED DEFAULT NULL,
  `iCityId` int(11) UNSIGNED DEFAULT NULL,
  `vAuthKey` varchar(100) NOT NULL,
  `vPasswordResetToken` varchar(255) DEFAULT NULL,
  `iCreatedAt` int(11) UNSIGNED NOT NULL,
  `iUpdatedAt` int(11) DEFAULT NULL,
  `tiIsActive` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1-Active,0-Inactive'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users_master` (`iUserId`, `vUserName`, `vEmailId`, `vPassword`, `vProfilePic`, `vMobileNo`, `iCountryId`, `iStateId`, `iCityId`, `vAuthKey`, `vPasswordResetToken`, `iCreatedAt`, `iUpdatedAt`, `tiIsActive`) VALUES
(2, 'bhargav10', 'bhargav.gohel@hodusoft.com', 'e10adc3949ba59abbe56e057f20f883e', '', '1234567890', NULL, NULL, NULL, '7d8a7e00eb3ae498b81612216dcd23b2', NULL, 1543986353, NULL, 1),
(3, 'test', 'test@gmail.com', '123456', '', '1234567890', 101, 12, 1928, 'test@gmail.com', NULL, 1544164692, NULL, 1),
(4, 'bhargav12', 'bhargav@gmail.com', '14e1b600b1fd579f47433b88e8d85291', '1544166462.jpeg', '1234567890', 101, 12, 1971, 'bhargav@gmail.com', NULL, 1544166462, NULL, 1);
...
CREATE TABLE `user_leaves` (
  `iUserLeaves` int(11) UNSIGNED NOT NULL,
  `iLeaveId` int(11) UNSIGNED NOT NULL,
  `iLeaveNameId` int(11) UNSIGNED NOT NULL,
  `dtDates` date NOT NULL,
  `tiDay` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1-Fullday,2-Halfday',
  `tiIsStatus` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1-Pending,2-Approved,3-Rejected',
  `iCreatedAt` int(11) UNSIGNED NOT NULL,
  `iUpdatedAt` int(11) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user_leaves` (`iUserLeaves`, `iLeaveId`, `iLeaveNameId`, `dtDates`, `tiDay`, `tiIsStatus`, `iCreatedAt`, `iUpdatedAt`) VALUES
(1, 2, 2, '2018-12-07', 0, 1, 1544087768, NULL),
(2, 2, 2, '2018-12-08', 0, 1, 1544087768, NULL),
(3, 2, 2, '2018-12-09', 0, 1, 1544087768, NULL),
(4, 2, 2, '2018-12-10', 0, 1, 1544087768, NULL);
...
--
-- Indexes for table `leaves_master`
--
ALTER TABLE `leaves_master`
  ADD PRIMARY KEY (`iLeaveId`),
  ADD KEY `iUserId` (`iUserId`);

--
-- Indexes for table `leaves_name`
--
ALTER TABLE `leaves_name`
  ADD PRIMARY KEY (`iLeaveNameId`);
...
ALTER TABLE `users_master`
  ...
  ADD KEY `iCountryId` (`iCountryId`),
  ADD KEY `iCountryId_2` (`iCountryId`),
  ADD KEY `iStateId` (`iStateId`),
...
ALTER TABLE `user_leaves`
  ADD PRIMARY KEY (`iUserLeaves`),
  ADD KEY `iLeaveId` (`iLeaveId`),
  ADD KEY `iLeaveNameId` (`iLeaveNameId`);
...
--
-- AUTO_INCREMENT for table `leaves_master`
--
ALTER TABLE `leaves_master`
  MODIFY `iLeaveId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `leaves_name`
--
ALTER TABLE `leaves_name`
  MODIFY `iLeaveNameId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `users_master`
  MODIFY `iUserId` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `user_leaves`
--
ALTER TABLE `user_leaves`
  MODIFY `iUserLeaves` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `city_master`
  ADD CONSTRAINT `city_master_ibfk_1` FOREIGN KEY (`iStateId`) REFERENCES `state_master` (`iStateId`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `leaves_master`
--
ALTER TABLE `leaves_master`
  ADD CONSTRAINT `leaves_master_ibfk_2` FOREIGN KEY (`iUserId`) REFERENCES `users_master` (`iUserId`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `state_master`
--
ALTER TABLE `state_master`
  ADD CONSTRAINT `state_master_ibfk_1` FOREIGN KEY (`iCountryId`) REFERENCES `country_master` (`iCountryId`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `users_master`
--
ALTER TABLE `users_master`
  ADD CONSTRAINT `users_master_ibfk_1` FOREIGN KEY (`iCountryId`) REFERENCES `country_master` (`iCountryId`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `users_master_ibfk_2` FOREIGN KEY (`iStateId`) REFERENCES `state_master` (`iStateId`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `users_master_ibfk_3` FOREIGN KEY (`iCityId`) REFERENCES `city_master` (`iCityId`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `user_leaves`
--
ALTER TABLE `user_leaves`
  ADD CONSTRAINT `user_leaves_ibfk_1` FOREIGN KEY (`iLeaveId`) REFERENCES `leaves_master` (`iLeaveId`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `user_leaves_ibfk_3` FOREIGN KEY (`iLeaveNameId`) REFERENCES `leaves_name` (`iLeaveNameId`) ON DELETE CASCADE ON UPDATE NO ACTION;
